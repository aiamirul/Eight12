...
import { StockChangeLog } from "../types";
...
export const LogViewer: React.FC<LogViewerProps> = ({ logs, onClearLogs }) => {
  ...
  return (
    <div id="log-viewer-container" className="bg-white rounded-2xl p-5 md:p-6 border border-zinc-200 shadow-sm relative overflow-hidden">
      ...
      <div className="hidden print-only print-container font-sans text-slate-900 bg-white">
        <div className="border-b-2 border-slate-900 pb-4 mb-4">
          <div className="flex justify-between items-end">
            <div>
              <h1 className="text-xl font-bold tracking-tight uppercase">8Twelve Convenient Stock Report</h1>
              <p className="text-xs text-slate-500">Official Shop Stock Update Audit Logs</p>
            </div>
        ...
        <table className="w-full text-xs text-left border-collapse">
          <thead>
            <tr className="border-b-2 border-slate-800 text-slate-800 font-bold uppercase tracking-wider text-[11px]">
              ...
              <th className="py-2 px-1 text-center">Prev</th>
              <th className="py-2 px-1 text-center">New</th>
            ...
            {processedLogs.map((log) => {
              ...
              return (
                <tr key={log.id} className="border-b border-slate-200">
                  ...
                  <td className="py-2 px-1 font-mono text-emerald-900">
                    {log.articleCode}
                  </td>
                  <td className="py-2 px-1 font-semibold">
                    {log.articleName}
                  ...
                  <td className="py-2 px-1 italic text-slate-600">
                    {log.remarks || "—"}
                  </td>
                </tr>
              );
        ...
        <div className="mt-8 border-t border-slate-300 pt-3 text-[10px] text-slate-400 text-center">
          &copy; 8Twelve Convenience Store Stock Management Ledger System. All rights reserved.
        </div>
      </div>
    </div>
  );
